...
{
    initSprites();
    m_menuMusic.openFromFile("menuBackground.ogg");
...
void Menu::drawMenu()
{
   ...
   m_window.draw(GameResources::getGameResources().createText("Michael Zargari and Yehuda Keller", sf::Vector2f(700, 760), sf::Color::Yellow, 0));
}